...
- Repomix packed output: [`repomix-ai-launchkit.xml`](repomix-ai-launchkit.xml) (gitignored). Auto-regenerated by `.githooks/post-commit` (opt in with `git config core.hooksPath .githooks`). See [`../../docs/repomix.md`](../../docs/repomix.md).
